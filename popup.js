        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $(objE).find(".TABLE_BODY .TABLE_TR_01,.TABLE_TR_02").map((index, element) => {
                    ...
                    classData["grade"] = parseInt($(element).find("td ul")[0].innerHTML);
...
function render(data) {
    ...
    Object.keys(data).forEach(element => {
        ...
        document.getElementById("toolbar").appendChild(label);
    });
    var button = document.createElement('button');
    button.className = 'btn btn-primary';
    button.appendChild(document.createTextNode("计算GPA"));
